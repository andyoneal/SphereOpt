    ...
    SubShader {
        ...
        Pass {
            ...
            fout frag(v2f i)
            {
                ...
                float4 v; //r4.xyzw
                v.xyz = (_NoiseTile * i.upDir) / 8.0; //r4.xyz
                v.w = _Time.y * _NoiseSpeed; //r4.w
                
                r6.x = sin(_RotSpeed * -v.w);
                r7.x = cos(_RotSpeed * -v.w);
                r5.x = sin(0.25 * _RotSpeed * -v.w);
                r8.x = cos(0.25 * _RotSpeed * -v.w);
                
                v.z = v.z * r7.x + v.x * r6.x;
                v.x = v.x * r7.x - v.x * r6.x;
...
//                     )
//                 ); //r6.xyzw
//                 float4 x0 = v - i + dot(i, C.xxxx); //r7.xyzw
//                 
//                 //r5.y = dot(r4.xyzw, float4(0.309017003,0.309017003,0.309017003,0.309017003)); // (sqrt(5) - 1) / 4
//                 //r6.xyzw = floor(r5.yyyy + r4.xyzw);
//                 //r7.xyzw = r4.xyzw - r6.xyzw;
//                 //r4.x = dot(r6.xyzw, float4(0.138196602,0.138196602,0.138196602,0.138196602)); // (5 - sqrt(5))/20
//                 //r7.xyzw = r7.xyzw + r4.xxxx;
//                 
//                 r3.xzw = v.xzw; //saving part of v
//                 
//                 // Other corners
//                 
//                 // Rank sorting originally contributed by Bill Licea-Kane, AMD (formerly ATI)
//                 float4 i0;
//                 float3 isX = step( x0.yzw, x0.xxx ); //r4.xyz
//                 float3 isYZ = step( x0.zww, x0.yyz ); //r2.xyz
//                 i0.x = isX.x + isX.y + isX.z; //r2.x
//                 i0.yzw = 1.0 - isX; //r5.yzw
//                 i0.y += isYZ.x + isYZ.y; //r2.y
//                 i0.zw += 1.0 - isYZ.xy;
//                 i0.z += isYZ.z;
//                 i0.w += 1.0 - isYZ.z;
//                 
//                 // i0 now contains the unique values 0,1,2,3 in each channel
//                 float4 i3 = saturate(i0); //r9.xyzw
//                 float4 i2 = saturate(i0-1.0); //r2.zw and r10.xy?
//                 float4 i1 = saturate(i0-2.0); //r2.xy and ??
//                 
//             //     float4 i0;
//             //     float3 isX = step( x0.yzw, x0.xxx ); //r4.xyz
//             //     float3 isYZ = step( x0.zww, x0.yyz ); //r2.xyz
//             //     i0.x = isX.x + isX.y + isX.z; //r2.x
//             //     i0.yzw = 1.0 - isX; //r5.yzw
//             //     r9.xyz = 1.0 - isYZ; //r9.xyz
//             //     
//             //     //r2.w = 1;
//             //     
//             //     //r2.y = r5.y + r2.x + r2.y;
//             //     r10.z = i0.w - (1.0 - isYZ.y) + isYZ.z;
//             //     r2.z = 1 + r10.z;
//             //     r10.w = i0.z - (1.0 - isYZ.x) + 1.0 - (1.0 - isYZ.z);
//             //     r2.w = 1 + r10.w;
//             // 
//             //     r9.xyzw = min(float4(1,1,1,1), r2.xyzw); //i3
//             //     
//             //     r10.xy = r2.xy;
//             //     
...
//                 float4 x1 = x0 - i1 + C.xxxx; // r2.xyzw
//                 float4 x2 = x0 - i2 + C.yyyy; // r10.xyzw
//                 float4 x3 = x0 - i3 + C.zzzz; // r9.xyzw
//                 float4 x4 = x0 + C.wwww; //r6.xyzw
//                 
//                 // Permutations
//                 i = mod289(i); //r6.xyzw
//                 
...
//                 
// 
//                 //r6.xyzw = r6.xyzw - floor(r6.xyzw / 289.0) * 289; //i
//                 
// //                 r1.x = r2.w;
// //                 r1.y = r10.w;
// //                 r1.z = r9.w;
...
//                 
//                 
//                 // r9.xyzw = 3.0 / (5.0 + sqrt(5.0)) + x0.xyzw - r9.xyzw; //0.414589792 // x3
//                 // 
//                 // r1.x = r2.x;
//                 // 
//                 // r2.xyzw = 1.0 / (5.0 + sqrt(5.0)) + x0.xyzw - r2.xyzw; //0.138196602 // x1
//                 // 
//                 // r1.y = r10.x;
//                 // 
//                 // r10.xyzw = 2.0 / (5.0 + sqrt(5.0)) + x0.xyzw - r10.xyzw; //0.2763932023 // x2
//                 // 
//                 // 
//                 // r0.xyzw = pow(r1.xyzw + r0.xyzw, 2) * 34.0 + r1.xyzw + r0.xyzw;
...
//                 // // r1.xyz = ip.xyz * r0.xxx;
//                 // // r1.xyz = floor(float3(7,7,7) * frac(r1.xyz));
//                 // // r1.xyz = (r1.xyz / 7.0) - float3(1,1,1); //0.14285715 //p.xyz
//                 // // r0.x = dot(-r1.xyz, float3(1,1,1));
//                 // // r11.w = 1.5 - r0.x;
//                 // // r0.x = r11.w >= 0 ? 0 : 1;
//                 // // r11.xyz = r1.xyz + r0.xxx; //p1
//                 // 
...
//                 // // r0.w = r6.w >= 0 ? 0 : 1;
//                 // // r6.xyz = r0.xyz + r0.www; //p0
//                 // 
//                 // r1.x = dot(r6.xyzw, r6.xyzw);
//                 // 
//                 // r0.xyzw = float4(1.79284286,1.79284286,1.79284286,1.79284286) - r1.xyzw * float4(0.853734732,0.853734732,0.853734732,0.853734732); //norm
//                 
//                 // r1.y = dot(r11.xyzw * r0.y, r2.xyzw); //dot(p1, x1)
//                 // r2.y = dot(r2.xyzw, r2.xyzw); //dot(x1, x1)
//                 // 
//                 // r1.z = dot(r12.xyzw * r0.z, r10.xyzw); //dot(p2, x2)
//                 // r2.z = dot(r10.xyzw, r10.xyzw); //dot(x2, x2)
//                 // 
//                 // r0.x = dot(r13.xyzw * r0.w, r9.xyzw); //dot(p3, x3)
//                 // r9.x = dot(r9.xyzw, r9.xyzw); //dot(x3, x3)
//                 // 
//                 // r1.x = dot(r6.xyzw * r0.x, x0.xyzw); //dot(p0, x0)
//                 // r2.x = dot(x0.xyzw, x0.xyzw); //dot(x0, x0)
//                 
//                 // r6.xyzw = x0.xyzw - (1.0 / sqrt(5)); //x4
//                 
//                 // r2.xyz = max(float3(0,0,0), float3(0.6, 0.6, 0.6) - r2.xyz); //m0
//                 r2.xyz = pow(r2.xyz, 4);
...
//                 // r0.w = r1.w >= 0 ? 0 : 1;
//                 // r1.xyz = r4.xyz + r0.www; //p4
//                 
//                 // r0.w = 1.79284286 - dot(r1.xyzw, r1.xyzw) * 0.853734732;
//                 // r0.w = r1.xyzw * r0.w; //p4
//                 
//                 // r0.y = dot(r0.w, r6.xyzw); // dot(p4, x4)
//                 // r9.y = dot(r6.xyzw, r6.xyzw); // dot(x4,x4)
//                 
//                 // r1.xy = max(float2(0,0), float2(0.6, 0.6) - r9.xy); //m1
//                 // r1.xy = pow(r1.xy,4); //^5?
//                 r0.x = r0.z + dot(r1.xy, r0.xy);
                // r0.x * 49.0 => return value of snoise(v)
                
                r0.y = r0.x * 0.2 - v.w;
                r1.xyzw = float4(2, 0.25, 2, 2) * v.xyzw;
                ...
                r0.x = r0.x + r0.y; //combined returns of the first two snorms
                
                r1.yw = r3.yw;
                r2.y = r1.y * 0.5 + r0.z;
                r2.xzw = float3(2,2,4) * r1.xzw;
                
                r0.y = snoise(r2.xyzw); //this one was weird at the end
                //snorm(r2.xyzw)
                ...
                r0.x = r0.y * 0.25 + r0.x; //r0.x is part of the return of snorm()
                
                r0.z = r0.y * 0.25 - v.w; // - r4.w
                r2.z = r1.z * 4 + r0.z;
                
                float r0_z_below = snoise(r2.xyzw);
                ...
                //where's the rest of snoise? this is just float4 norm * v? I think
                
                // r2.w = 1;
                // r15.w = 1;
                // r16.w = 1;
                
                r17.xyzw = _ChaosTile * v.xyzw;
                ...
                r0.y = min(1, 0.9 * sin(r0.y - 0.5 * abs(r0.z)) + 1.0);
                ...
                r0.x = max(0,(r0_z_below * 0.125 + r0.x) * 0.2 + 0.6);
                
                r4.xyzw = float4(0.09, 0.01125, 0.09, 0.36) * v.xyzw;
                r0.z = snoise(r4.xyzw);
                ...
                r0.w = r0.y * saturate(-r0.z - 0.55);
                
                r0.z = r0.y * saturate(r0.z - 0.7);
