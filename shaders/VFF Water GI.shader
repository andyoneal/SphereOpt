    ...
    SubShader {
        ...
        Pass {
            ...
            fout frag(v2f inp) {
                ...
                bumpUV_X1.x = tiledNormal.x; // r2.xw
                bumpUV_X1.y = tiledNormal.y + tiledAnim; // r2.xw
                
                float2 bumpX1 = SampleBumpTex(bumpUV_X2);
                float2 bumpY1 = SampleBumpTex(bumpUV_Y2);
                float2 bumpZ1 = SampleBumpTex(bumpUV_Z2);
                ...
                bumpUV_X2.x = bumpZ1.x * 0.15 + tiledAnim - tiledNormal.x; // r1.x
                bumpUV_X2.y = bumpZ1.y * 0.15 - tiledAnim + tiledNormal.y; // r1.w
